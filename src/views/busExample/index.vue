<template>
  <div>
    ...
    <get-mob-phone-no ref="mobPhoneNo"></get-mob-phone-no>
    <mob-pwd-code itemName="动态验证码"></mob-pwd-code>
  </div>
</template>
<script>
import TitleBar from "@/components/TitleBar";
import GetMobPhoneNo from "./components/getMobPhoneNo";
import MobPwdCode from "./components/mobPwdCode";
export default {
  name: "",
  components: {
    TitleBar,
